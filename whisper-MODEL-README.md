...
2. 从 HuggingFace 官方仓库断点续传下载以下 5 个文件：
...
- **网络受限环境**：若 HuggingFace 官方仓库访问缓慢，可在下载前设置镜像端点
  `HF_ENDPOINT=https://hf-mirror.com`，并确保 `HF_HUB_DISABLE_XET=1`（docker-compose.yml 已配置）。
